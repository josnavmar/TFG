...
class DataManager(object):
    """Clase para carga los datasets FER2013 y IMDB"""
    def __init__(self, dataset_name='imdb',
        ...
        if self.dataset_path is not None:
            ...
            self.dataset_path = '../datasets/imdb_crop/imdb_crop/imdb.mat'
...
def get_labels(dataset_name):
    if dataset_name == 'fer2013':
        return {0: 'Enfadado', 1: 'Asqueado', 2: 'Miedoso', 3: 'Feliz',
                4: 'Triste', 5: 'Sorprendido', 6: 'Neutral'}
    elif dataset_name == 'imdb':
        return {0: 'Mujer', 1: 'Hombre'}
